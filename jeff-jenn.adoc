...
include::MajorOpenings\Raises\twowayreversedrury.adoc

### Jump Shifts

include::MajorOpenings\JumpShifts\WeakJS.adoc
...
include::MinorOpenings\OneOverOne\ResponderRebid\new-minor-forcing.adoc
...
include::Defense\Signals\UDA.adoc
